                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price') }}" step="0.01"
                            min="0" required class="form-input mt-1">
                        @error('price')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="compare_price" id="compare_price" value="{{ old('compare_price') }}"
                            step="0.01" min="0" class="form-input mt-1">
                        @error('compare_price')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="colors" id="colors" value="{{ old('colors') }}"
                            placeholder="Red, Blue, Green" class="form-input mt-1">
                    ...
                    <div>
                        ...
                        <input type="text" name="sizes" id="sizes" value="{{ old('sizes') }}"
                            placeholder="S, M, L, XL" class="form-input mt-1">
