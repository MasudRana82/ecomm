                    ...
                    @foreach ($relatedProducts as $relatedProduct)
                        <div
                            ...
                            @if ($relatedProduct->discount_percentage > 0)
                                <span
                                    class="absolute top-2 left-2 bg-red-500 text-white text-xs font-semibold px-2 py-1 rounded-full z-10">
                            ...
                            <div class="p-4">
                                ...
                                @if ($relatedProduct->compare_price > $relatedProduct->price)
                                    <p class="text-lg font-bold custom-orange mb-3">
                                        ...
                                        <span
                                            class="text-sm font-normal text-gray-500 line-through">৳{{ number_format($relatedProduct->compare_price, 2) }}</span>
                                    </p>
                                @else
                                    <p class="text-lg font-bold custom-orange mb-3">
                                ...
                                <button
                                    class="w-full bg-custom-orange text-white py-2 rounded-md hover:bg-custom-orange-dark transition-colors duration-300 related-add-to-cart mb-2"
                                ...
                                <button
                                    class="w-full bg-gray-900 text-white py-2 rounded-md hover:bg-gray-800 transition-colors duration-300 related-buy-now"
                                    data-product-id="{{ $relatedProduct->id }}"
                                    data-product-name="{{ $relatedProduct->name }}">
                                    Buy Now
                                </button>
